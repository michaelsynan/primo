...
<template>
    <div v-if="location && service" class="flex flex-col justify-center gap-4 min-h-screen mx-auto pb-20 bg-stone-950">
        <div id="header-div"
            ...
            <h1
                class="absolute inset-0 flex items-center justify-center text-3xl md:text-5xl text-stone-50 fancy z-[2]">
        ...
        <div class="px-4 md:px-0">
            <div class="max-w-4xl mx-auto">
                ...
                <div v-if="service.details">
                    <div v-for="(value, key) in service.details" :key="key">
                ...
                <div class="mt-12">
                    <h2 class="text-2xl font-bold mb-4 text-center">Other Services in {{ location.name }}</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div v-for="otherService in services.filter(s => s.slug !== service.slug)"
                            ...
                            <NuxtLink :to="`/service-area/${location.slug}/${otherService.slug}`" class="block">
                                <div class="flex flex-col h-full">
                                    <h3
                                        class="text-xl font-bold text-stone-50 mb-3 group-hover:text-primoGreen transition-colors">
