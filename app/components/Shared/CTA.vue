...
<template>
  <div
    class="relative max-w-4xl mx-auto w-full rounded-sm border bg-gradient-to-b from-stone-800/40 to-stone-900/40 text-primoWhite text-center py-10 md:py-12 my-10 flex flex-col gap-5 md:gap-6 px-8">
    ...
    <div class="block md:hidden">
      <h2 class="text-2xl md:text-3xl font-bold leading-tight">
        Need Immediate Help?<div class="block pt-4"> Call Now. </div>
      </h2>
    </div>
