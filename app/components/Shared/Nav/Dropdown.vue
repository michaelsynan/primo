...
<template>
  <div class="rounded-bl">
    <ul role="menu">
      <li class="border-b border-stone-800 py-2 text-stone-300 hover:text-stone-50 w-full" role="menuitem">
      ...
      <li class="text-stone-300 hover:text-stone-50 w-full" role="menuitem">
        <NuxtLink to="/contact-a-plumber" class="w-full block py-2 px-4 hover:bg-stone-800">
          Contact Us
        </NuxtLink>
      </li>
    </ul>
